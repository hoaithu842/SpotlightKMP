...
object SpotlightIcons {
    ...
    val HomeSelected = Res.drawable.home_selected
    val Search = Res.drawable.search
    val SearchSelected = Res.drawable.search_selected
    val Library = Res.drawable.library
    val LibrarySelected = Res.drawable.library_selected
    val Premium = Res.drawable.premium
    val Add = Res.drawable.add
    val Lightning = Res.drawable.lightning
